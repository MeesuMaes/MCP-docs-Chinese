...
此页面展示了各种模型上下文协议 (MCP) 服务器，这些服务器展示了该协议的功能和灵活性。这些服务器使大型语言模型 (LLM) 能够安全地访问工具和数据源。

## 参考实现

以下官方参考服务器展示了核心 MCP 功能和 SDK 的使用：

### 数据和文件系统
- **[文件系统](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem)** - 带有可配置访问控制的安全文件操作
- **[PostgreSQL](https://github.com/modelcontextprotocol/servers/tree/main/src/postgres)** - 提供只读数据库访问和模式检查功能
...
### 开发工具
- **[Git](https://github.com/modelcontextprotocol/servers/tree/main/src/git)** - 工具用于读取、搜索和操作 Git 仓库
- **[GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/github)** - 仓库管理、文件操作和 GitHub API 集成
- **[GitLab](https://github.com/modelcontextprotocol/servers/tree/main/src/gitlab)** - GitLab API 集成支持项目管理
...
- **[Fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch)** - 针对 LLM 使用优化的网页内容抓取和转换
...
- **[Google Maps](https://github.com/modelcontextprotocol/servers/tree/main/src/google-maps)** - 地图服务、路线规划和地点详情
...
- **[Sequential Thinking](https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking)** - 通过思维序列实现动态问题解决
...
以下 MCP 服务器由公司维护以支持其平台：

- **[Axiom](https://github.com/axiomhq/mcp-server-axiom)** - 使用自然语言查询和分析日志、跟踪和事件数据
- **[Browserbase](https://github.com/browserbase/mcp-server-browserbase)** - 在云端实现浏览器交互自动化
...
- **[Obsidian Markdown 笔记](https://github.com/calclavia/mcp-obsidian)** - 读取和搜索 Obsidian 保管库中的 Markdown 笔记
...
- **[Search1API](https://github.com/fatwang2/search1api-mcp)** - 统一的搜索、爬取和站点地图 API
...
> **注意：** 社区服务器未经测试，使用需自担风险。它们与 Anthropic 无关，也未获得其认可。

要查看完整的社区服务器列表，请访问 [MCP 服务器仓库](https://github.com/modelcontextprotocol/servers)。
...
- [Supergateway](https://github.com/supercorp-ai/supergateway) - 通过 SSE 运行 MCP 标准输入输出服务器
- [Zapier MCP](https://zapier.com/mcp) - 支持 7,000+ 应用程序和 30,000+ 操作的 MCP 服务器
